...
describe('Fields', () => {
  ...
  describe('#createOrUpdate', () => {
    ...
    it('should be possible to create a field', () => {
      ...
      client.fields.createOrUpdate('my_index', { name: 'my_field', stored: true });

      expect(rq).to.be.calledWith({
        method: 'PUT',
        pathname: '/services/rest/index/my_index/field/my_field',
        json: { name: 'my_field', stored: 'YES' }
      });
    });
  ...
  describe('#setUniqueDefault', () => {
    ...
    it('should be possible to define unique and default field', () => {
      ...
      client.fields.setUniqueDefault('my_index', { default: 'my_default_field', unique: 'my_unique_field' });

      expect(rq).to.be.calledWith({
        method: 'POST',
        pathname: '/services/rest/index/my_index/field',
        qs: { default: 'my_default_field', unique: 'my_unique_field' }
      });
    });
  });
